<?php
    ...
    class CCurso {
        ...
        public static function confirmar($id) {
            ...
            if($_POST['nome'] != "" && $_POST['area'] != "" && $_POST['nivel'] != "") {

                $dados_curso = array("nome" => mb_strtoupper($_POST['nome'], 'UTF-8'),
                    "area" => mb_strtoupper($_POST['area'], 'UTF-8'), 
                ...
                if($id == 0) {
                    ...
                    $_SESSION['MSGBOX_MSG'] = "O curso foi cadastrada no sistema!";
                }
                // Alterar
                else {
        ...
        public static function finalizar($id) {
            ...
            $_SESSION['MSGBOX_TITULO'] = "OPERAÇÃO REALIZADA COM SUCESSO!";
            $_SESSION['MSGBOX_MSG'] = "O curso foi removida do sistema!";
            $_SESSION['MSGBOX_LINK'] = "curso.php";
            $_SESSION['MSGBOX_CLASSE'] = "alert alert-success";
        ...
        public static function pegaCursos(){
            return Curso::getCursos();
        }
        public static function pesquisarCursos($id){
